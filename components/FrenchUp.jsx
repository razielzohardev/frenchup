...
const BANK_A1 = {
  ...
  exp: [
    [ /* 0 — Se présenter */
      { instruction_he:"הצג את עצמך", prompt_fr:"Présentez-vous : prénom, âge et ville.", trans_he:"הצג את עצמך: שמך, גילך ועירך.", model_fr:"Je m'appelle David. J'ai vingt ans. J'habite à Tel Aviv.", model_he:"שמי דוד. אני בן עשרים. אני גר בתל אביב.", keys_fr:["Je m'appelle","J'ai ... ans","J'habite à"], tip_he:"Je m'appelle · J'ai ... ans · J'habite à." },
      { instruction_he:"ספר מה אתה לומד/עובד", prompt_fr:"Qu'est-ce que tu fais dans la vie ?", trans_he:"מה אתה עושה בחיים?", model_fr:"Je suis étudiant en informatique à l'université. J'étudie depuis deux ans.", model_he:"אני סטודנט למדעי המחשב באוניברסיטה. אני לומד כבר שנתיים.", keys_fr:["Je suis","étudiant","je travaille","depuis"], tip_he:"Je suis étudiant(e) · Je travaille comme... · Je fais des études de..." },
      { instruction_he:"ספר על שפות שאתה מדבר", prompt_fr:"Quelles langues parles-tu ?", trans_he:"אילו שפות אתה מדבר?", model_fr:"Je parle hébreu et anglais. En ce moment, j'apprends le français.", model_he:"אני מדבר עברית ואנגלית. כרגע אני לומד צרפתית.", keys_fr:["Je parle","j'apprends","aussi","un peu de"], tip_he:"Je parle français · J'apprends l'espagnol · Je parle un peu de..." },
    ],
    [ /* 1 — Ma famille */
      { instruction_he:"תאר את המשפחה שלך", prompt_fr:"Décris ta famille.", trans_he:"תאר את המשפחה שלך.", model_fr:"Dans ma famille, il y a mon père, ma mère et ma sœur. Mon père s'appelle Ilan.", model_he:"במשפחתי יש אבא, אמא ואחות. אבא שלי נקרא אילן.", keys_fr:["dans ma famille","il y a","mon père","ma mère","s'appelle"], tip_he:"il y a = יש · mon père = אבא · ma mère = אמא · mon frère = אחי." },
      { instruction_he:"ספר על אחד מבני משפחתך", prompt_fr:"Décris un membre de ta famille.", trans_he:"תאר אחד מבני משפחתך.", model_fr:"Mon frère s'appelle Noah. Il a vingt-cinq ans. Il est grand et brun. Il habite à Haïfa.", model_he:"אחי נקרא נח. הוא בן עשרים וחמש. הוא גבוה ובעל שיער כהה. הוא גר בחיפה.", keys_fr:["il s'appelle","il a ... ans","il est","il habite"], tip_he:"il s'appelle · il a ... ans · il est + adj · il habite." },
      { instruction_he:"ספר על הסבים שלך", prompt_fr:"Parle de tes grands-parents.", trans_he:"ספר על הסבים שלך.", model_fr:"Mes grands-parents habitent à Jérusalem. Ma grand-mère fait de très bons gâteaux.", model_he:"הסבים שלי גרים בירושלים. סבתא שלי אופה עוגות מאוד טעימות.", keys_fr:["mes grands-parents","ma grand-mère","mon grand-père","il/elle aime"], tip_he:"mon grand-père = סבא · ma grand-mère = סבתא · mes grands-parents = הסבים." },
    ],
    [ /* 2 — J'aime… */
      { instruction_he:"מה אתה אוהב לעשות?", prompt_fr:"Qu'est-ce que tu aimes faire ? Donne deux exemples.", trans_he:"מה אתה אוהב לעשות?", model_fr:"J'aime écouter de la musique et jouer au football. Je n'aime pas faire la cuisine.", model_he:"אני אוהב להאזין למוזיקה ולשחק כדורגל. אני לא אוהב לבשל.", keys_fr:["J'aime","Je n'aime pas","et"], tip_he:"J'aime + infinitif: jouer, écouter, regarder, lire." },
      { instruction_he:"ספר על תחביב אהוב", prompt_fr:"Parle d'un hobby que tu aimes. Pourquoi ?", trans_he:"ספר על תחביב שאתה אוהב ולמה.", model_fr:"J'aime beaucoup lire. Je lis des romans et des bandes dessinées. C'est relaxant.", model_he:"אני מאוד אוהב לקרוא. אני קורא רומנים וקומיקסים. זה מרגיע.", keys_fr:["j'aime beaucoup","je lis","c'est","parce que"], tip_he:"J'aime + infinitif · C'est + adj · parce que (כי)." },
      { instruction_he:"ספר על מוזיקה או סרט", prompt_fr:"Quel film ou quelle chanson tu aimes ?", trans_he:"איזה סרט או שיר אתה אוהב?", model_fr:"J'aime beaucoup la musique reggae. C'est très relaxant. J'écoute quand je suis stressé.", model_he:"אני מאוד אוהב מוזיקת רגאיי. זה מאוד מרגיע. אני מאזין כשאני לחוץ.", keys_fr:["j'aime","c'est","j'écoute","quand"], tip_he:"J'aime la musique de... · C'est + adj · J'écoute / Je regarde." },
    ],
    [ /* 3 — Ma journée */
      { instruction_he:"תאר את הבוקר שלך", prompt_fr:"Décris ton matin.", trans_he:"תאר את הבוקר שלך.", model_fr:"Je me réveille à sept heures. Je prends une douche et je mange un petit-déjeuner. Ensuite je vais au travail.", model_he:"אני מתעורר בשבע. אני מתקלח ואוכל ארוחת בוקר. אחר כך אני הולך לעבודה.", keys_fr:["je me réveille","je prends","ensuite","je vais"], tip_he:"Je me réveille · Je me lève · Je prends une douche · Ensuite." },
      { instruction_he:"תאר את הערב שלך", prompt_fr:"Qu'est-ce que tu fais le soir normalement ?", trans_he:"מה אתה עושה בדרך כלל בערב?", model_fr:"Le soir, je rentre à la maison vers dix-neuf heures. Je mange avec ma famille. Après, je regarde la télé.", model_he:"בערב, אני חוזר הביתה בסביבות שבע. אני אוכל עם המשפחה שלי. אחר כך, אני צופה בטלוויזיה.", keys_fr:["le soir","je rentre","vers","je mange","après"], tip_he:"le soir (בערב) · après (אחרי כן) · normalement (בדרך כלל)." },
      { instruction_he:"תאר יום שגרתי שלך", prompt_fr:"Décris une journée typique.", trans_he:"תאר יום שגרתי שלך.", model_fr:"D'habitude, je me lève à sept heures. Je mange du pain avec du café. Je vais au bureau à huit heures et demie.", model_he:"בדרך כלל, אני קם בשבע. אני אוכל לחם עם קפה. אני הולך למשרד בשמונה וחצי.", keys_fr:["d'habitude","je me lève","je mange","je vais"], tip_he:"d'habitude · d'abord · ensuite · enfin." },
    ],
    [ /* 4 — Mon école */
      { instruction_he:"ספר על בית הספר שלך", prompt_fr:"Parle de ton école ou de tes études.", trans_he:"ספר על בית הספר שלך.", model_fr:"Je suis au lycée. Il y a environ huit cents élèves. Mon cours préféré est la biologie.", model_he:"אני בתיכון. יש כשמונה מאות תלמידים. השיעור האהוב עלי הוא ביולוגיה.", keys_fr:["je suis au","il y a","mon cours préféré"], tip_he:"une école · un lycée · une université · un cours (שיעור)." },
      { instruction_he:"ספר על המורה האהוב עליך", prompt_fr:"Décris ton professeur préféré.", trans_he:"תאר את המורה האהוב עליך.", model_fr:"Mon professeur préféré s'appelle Monsieur Cohen. Il enseigne les mathématiques. Il est patient.", model_he:"המורה האהוב עלי נקרא מר כהן. הוא מלמד מתמטיקה. הוא סבלני.", keys_fr:["il s'appelle","il enseigne","il est"], tip_he:"il/elle enseigne (מלמד/ת) · il/elle est sympa/patient(e)." },
      { instruction_he:"ספר על חברים בבית הספר", prompt_fr:"Parle de tes amis à l'école.", trans_he:"ספר על החברים שלך בבית הספר.", model_fr:"J'ai beaucoup d'amis à l'école. Mon meilleur ami s'appelle Roni. On mange ensemble à la cantine.", model_he:"יש לי הרבה חברים בבית הספר. החבר הכי טוב שלי נקרא רוני. אנחנו אוכלים יחד בקפיטריה.", keys_fr:["j'ai","mon meilleur ami","on mange","ensemble"], tip_he:"mon meilleur ami = החבר הטוב ביותר · on = nous." },
    ],
    [ /* 5 — Mon pays */
      { instruction_he:"ספר על המדינה שלך", prompt_fr:"Parle de ton pays.", trans_he:"ספר על המדינה שלך.", model_fr:"Je viens d'Israël. C'est un petit pays au Moyen-Orient. Il y a environ neuf millions d'habitants.", model_he:"אני מישראל. זוהי מדינה קטנה במזרח התיכון. יש כתשעה מיליון תושבים.", keys_fr:["je viens de","c'est un pays","il y a ... habitants"], tip_he:"Je viens de · c'est un pays · la capitale est." },
      { instruction_he:"ספר על עיר בארצך", prompt_fr:"Décris une ville de ton pays.", trans_he:"תאר עיר אחת בארצך.", model_fr:"Tel Aviv est une grande ville moderne au bord de la mer. Il y a beaucoup de restaurants et de plages.", model_he:"תל אביב היא עיר גדולה ומודרנית על שפת הים. יש הרבה מסעדות וחופים.", keys_fr:["c'est une ville","au bord de","il y a","très"], tip_he:"c'est une ville + adj · grande/petite/moderne/historique." },
      { instruction_he:"ספר על האוכל של ארצך", prompt_fr:"Décris un plat typique de ton pays.", trans_he:"תאר מנה טיפוסית ממדינתך.", model_fr:"En Israël, on mange beaucoup de houmous et de falafel. C'est bon et pas cher.", model_he:"בישראל, אוכלים הרבה חומוס ופלאפל. זה טעים וזול.", keys_fr:["on mange","c'est","souvent","typique"], tip_he:"on mange = אנחנו אוכלים · c'est bon = זה טעים." },
    ],
  ],
};
...
const BANK_A2 = {
  ...
  exp: [
    [ /* 0 — Hier… (passé composé) */
      { instruction_he:"ספר מה עשית אתמול", prompt_fr:"Qu'est-ce que tu as fait hier ? Utilise le passé composé.", trans_he:"מה עשית אתמול? השתמש ב-passé composé.", model_fr:"Hier, je me suis levé à sept heures. J'ai mangé des céréales. Ensuite, je suis allé au travail. Le soir, j'ai regardé un film.", model_he:"אתמול קמתי בשבע. אכלתי דגני בוקר. אחר כך הלכתי לעבודה. בערב, צפיתי בסרט.", keys_fr:["hier","j'ai + participe","je suis allé(e)","ensuite","le soir"], tip_he:"passé composé: j'ai mangé · j'ai regardé · je suis allé(e) · je suis rentré(e)." },
      { instruction_he:"ספר על אירוע מהשבוע שעבר", prompt_fr:"Qu'est-ce que tu as fait la semaine dernière ?", trans_he:"מה עשית בשבוע שעבר?", model_fr:"La semaine dernière, j'ai travaillé beaucoup. Mercredi soir, je suis sorti avec des amis. On a mangé dans un bon restaurant.", model_he:"בשבוע שעבר, עבדתי הרבה. ביום רביעי בערב, יצאתי עם חברים. אכלנו במסעדה טובה.", keys_fr:["la semaine dernière","j'ai travaillé","je suis sorti(e)","on a mangé"], tip_he:"la semaine dernière (שבוע שעבר) · hier soir (אמש) · avant-hier (שלשום)." },
      { instruction_he:"ספר על ביקור שעשית", prompt_fr:"Décris une visite que tu as faite récemment.", trans_he:"תאר ביקור שעשית לאחרונה.", model_fr:"Le mois dernier, je suis allé à Tel Aviv. J'ai visité un musée et j'ai mangé dans un restaurant sympa. C'était super.", model_he:"בחודש שעבר, הלכתי לתל אביב. ביקרתי במוזיאון ואכלתי במסעדה נחמדה. זה היה נהדר.", keys_fr:["je suis allé(e)","j'ai visité","j'ai mangé","c'était"], tip_he:"c'était = זה היה (imparfait de être) — להבעת הרגשה." },
    ],
    [ /* 1 — Mon appart */
      { instruction_he:"תאר את הדירה שלך", prompt_fr:"Décris ton appartement ou ta maison.", trans_he:"תאר את הדירה או הבית שלך.", model_fr:"J'habite dans un appartement au troisième étage. Il y a trois pièces : un salon, une chambre et une cuisine. C'est assez grand et lumineux.", model_he:"אני גר בדירה בקומה השלישית. יש שלושה חדרים: סלון, חדר שינה ומטבח. זה די גדול ומוצף אור.", keys_fr:["j'habite dans","il y a","un salon","une chambre","assez"], tip_he:"un salon · une chambre · une cuisine · une salle de bains." },
      { instruction_he:"תאר את החדר שלך", prompt_fr:"Décris ta chambre.", trans_he:"תאר את החדר שלך.", model_fr:"Ma chambre est petite mais confortable. Il y a un lit, un bureau et une armoire. J'ai des posters sur les murs.", model_he:"החדר שלי קטן אבל נוח. יש מיטה, שולחן עבודה וארון. יש לי פוסטרים על הקירות.", keys_fr:["ma chambre est","il y a","un lit","un bureau","sur les murs"], tip_he:"un lit (מיטה) · un bureau (שולחן עבודה) · une armoire (ארון) · les murs (הקירות)." },
      { instruction_he:"ספר על השכנות שלך", prompt_fr:"Parle de ton quartier ou de tes voisins.", trans_he:"ספר על שכונתך או שכניך.", model_fr:"Mon appartement est dans un quartier calme. Mes voisins sont sympas. Il y a un parc à deux minutes à pied.", model_he:"הדירה שלי נמצאת בשכונה שקטה. השכנים שלי נחמדים. יש גינה ציבורית במרחק שתי דקות הליכה.", keys_fr:["mon appartement est","dans un quartier","mes voisins","à deux minutes"], tip_he:"un quartier calme/animé · les voisins (שכנים) · à ... minutes à pied." },
    ],
    [ /* 2 — Mon week-end */
      { instruction_he:"תאר את סוף השבוע שלך", prompt_fr:"Raconte ce que tu fais normalement le week-end.", trans_he:"ספר מה אתה עושה בדרך כלל בסוף השבוע.", model_fr:"Le samedi matin, je fais les courses au marché. L'après-midi, je retrouve mes amis en ville. Le dimanche, je reste chez moi.", model_he:"בבוקר של שבת, אני קונה בשוק. אחר הצהריים, אני נפגש עם חברים בעיר. ביום ראשון, אני נשאר בבית.", keys_fr:["le samedi","le dimanche","je fais","l'après-midi","en ville"], tip_he:"présent לתיאור הרגל: je fais, je retrouve, je reste, je lis." },
      { instruction_he:"ספר על סוף שבוע מיוחד", prompt_fr:"Décris un week-end particulièrement agréable.", trans_he:"תאר סוף שבוע מהנה במיוחד.", model_fr:"Le week-end dernier était super. Samedi, je suis allé à la plage avec des amis. Il faisait beau. Le soir, on a fait un barbecue.", model_he:"סוף השבוע שעבר היה נהדר. בשבת, הלכתי לחוף עם חברים. היה יפה. בערב, עשינו ברביקיו.", keys_fr:["le week-end dernier","je suis allé(e)","il faisait beau","le soir","on a fait"], tip_he:"mélanger passé composé et imparfait: actions (PC) + contexte (imparfait)." },
      { instruction_he:"ספר על תוכניות לסוף השבוע", prompt_fr:"Qu'est-ce que tu vas faire ce week-end ?", trans_he:"מה אתה הולך לעשות בסוף השבוע?", model_fr:"Ce week-end, je vais rendre visite à ma famille. On va manger ensemble et regarder un film. J'ai hâte !", model_he:"בסוף השבוע הזה, אני הולך לבקר את המשפחה שלי. נאכל יחד ונצפה בסרט. אני מצפה לזה!", keys_fr:["je vais","on va","hâte","ce week-end"], tip_he:"futur proche: je vais + infinitif · J'ai hâte = אני מצפה בקוצר רוח." },
    ],
    [ /* 3 — Mes goûts */
      { instruction_he:"ספר על הטעמים שלך", prompt_fr:"Parle de ce que tu aimes et n'aimes pas.", trans_he:"ספר על מה שאתה אוהב ולא אוהב.", model_fr:"J'adore la musique et le cinéma. Je n'aime pas tellement les sports d'équipe, mais j'aime nager. En général, je préfère les activités calmes.", model_he:"אני מאוד אוהב מוזיקה וקולנוע. אני לא כל כך אוהב ספורט קבוצתי, אבל אני אוהב לשחות. בדרך כלל, אני מעדיף פעילויות שקטות.", keys_fr:["j'adore","je n'aime pas tellement","mais","je préfère","en général"], tip_he:"j'adore · j'aime beaucoup · je n'aime pas tellement · je déteste." },
      { instruction_he:"השווה שני דברים שאתה אוהב", prompt_fr:"Compare deux choses que tu aimes.", trans_he:"השווה שני דברים שאתה אוהב.", model_fr:"J'aime le café et le thé, mais je préfère le café. Le thé est plus doux, mais le café est plus fort et me réveille mieux.", model_he:"אני אוהב קפה ותה, אבל אני מעדיף קפה. התה יותר עדין, אבל הקפה חזק יותר ומעיר אותי טוב יותר.", keys_fr:["je préfère","plus ... que","mais","le/la ... est plus"], tip_he:"plus + adj + que = יותר...מ-. moins + adj + que = פחות...מ-. aussi ... que = כמו." },
      { instruction_he:"ספר על ז'אנר מוזיקה אהוב", prompt_fr:"Décris le genre de musique que tu aimes.", trans_he:"תאר את הסגנון מוזיקלי האהוב עליך.", model_fr:"J'aime beaucoup le jazz. C'est une musique douce et sophistiquée. J'écoute du jazz quand je travaille ou quand je me repose.", model_he:"אני מאוד אוהב ג'אז. זוהי מוזיקה עדינה ומתוחכמת. אני שומע ג'אז כשאני עובד או כשאני נח.", keys_fr:["j'aime beaucoup","c'est une musique","j'écoute","quand"], tip_he:"le jazz · le rock · la musique classique · le rap · la chanson française." },
    ],
    [ /* 4 — Ma routine */
      { instruction_he:"תאר את השגרה היומיומית שלך", prompt_fr:"Décris ta routine quotidienne.", trans_he:"תאר את השגרה היומיומית שלך.", model_fr:"Je me lève à six heures et demie. Je prends une douche, puis je mange. Je vais au bureau en métro. Le soir, je rentre vers dix-neuf heures.", model_he:"אני קם בשש וחצי. אני מתקלח, אחר כך אוכל. אני הולך למשרד ברכבת תחתית. בערב, אני חוזר בסביבות שבע.", keys_fr:["je me lève","je prends","je vais","le soir","je rentre"], tip_he:"d'abord · ensuite · puis · après · enfin." },
      { instruction_he:"ספר על בוקר שגרתי", prompt_fr:"Décris un matin typique chez toi.", trans_he:"תאר בוקר שגרתי שלך.", model_fr:"Mon réveil sonne à sept heures. Je me lève dix minutes après. Je me douche et je m'habille. Je mange des toasts et je bois du café.", model_he:"השעון המעורר שלי מצלצל בשבע. אני קם עשר דקות אחר כך. אני מתקלח ומתלבש. אני אוכל טוסטים ושותה קפה.", keys_fr:["mon réveil sonne","je me lève","je me douche","je m'habille","je mange"], tip_he:"se lever · se doucher · s'habiller · prendre le petit-déjeuner · partir." },
      { instruction_he:"ספר מה אתה עושה בשעות הפנאי", prompt_fr:"Que fais-tu le soir après le travail ?", trans_he:"מה אתה עושה בערב אחרי העבודה?", model_fr:"Après le travail, je vais souvent faire du sport. Ensuite, je prépare le dîner et je regarde la télé ou je lis un peu.", model_he:"אחרי העבודה, אני לעתים קרובות הולך לעשות ספורט. אחר כך, אני מכין ארוחת ערב וצופה בטלוויזיה או קורא קצת.", keys_fr:["après le travail","je vais faire","ensuite","je prépare","je regarde"], tip_he:"après (אחרי) · ensuite (אחר כך) · souvent (לעתים קרובות)." },
    ],
    [ /* 5 — Mon quartier */
      { instruction_he:"תאר את השכונה שלך", prompt_fr:"Décris ton quartier.", trans_he:"תאר את השכונה שלך.", model_fr:"J'habite dans un quartier animé près du centre-ville. Il y a beaucoup de cafés, de restaurants et de boutiques. C'est pratique mais parfois bruyant.", model_he:"אני גר בשכונה תוססת ליד מרכז העיר. יש הרבה בתי קפה, מסעדות וחנויות. זה נוח אבל לפעמים רועש.", keys_fr:["j'habite dans","un quartier","il y a","c'est","mais"], tip_he:"animé (תוסס) · calme (שקט) · pratique (נוח) · bruyant (רועש) · propre (נקי)." },
      { instruction_he:"ספר על חנויות/שירותים בקרבתך", prompt_fr:"Quels commerces ou services y a-t-il près de chez toi ?", trans_he:"אילו חנויות/שירותים יש בקרבת ביתך?", model_fr:"Près de chez moi, il y a une boulangerie, un supermarché et une pharmacie. Il y a aussi un parc où je me promène le week-end.", model_he:"ליד הבית שלי יש מאפייה, סופרמרקט ובית מרקחת. יש גם גינה ציבורית שבה אני מטייל בסוף השבוע.", keys_fr:["près de chez moi","il y a","aussi","où je"], tip_he:"une boulangerie · un supermarché · une pharmacie · une poste · un parc." },
      { instruction_he:"השווה שכונות", prompt_fr:"Compare ton quartier à un autre endroit que tu connais.", trans_he:"השווה את שכונתך לאזור אחר שאתה מכיר.", model_fr:"Mon quartier est plus calme que le centre-ville, mais moins animé. Il y a moins de restaurants mais plus d'espaces verts. Je préfère le calme.", model_he:"השכונה שלי יותר שקטה ממרכז העיר, אבל פחות תוססת. יש פחות מסעדות אבל יותר שטחים ירוקים. אני מעדיף את השקט.", keys_fr:["plus ... que","moins ... que","mais","je préfère"], tip_he:"plus calme que · moins animé · autant de · je préfère." },
    ],
  ],
};
...
const BANK_B1 = {
  ...
  gra: [
    ...
    [ /* 2 — Pronoms COD (le/la/les) */
      ...
      { instruction_he:"COD: placement avec infinitif", prompt_fr:"Je vais appeler ma sœur. → Je vais ____ appeler.", trans_he:"אני הולך להתקשר לאחותי. → אני הולך להתקשר אליה.", accepted:["l'", "l’"], solution_fr:"Je vais l'appeler.", explanation_he:"עם futur proche: COD נמצא לפני ה-infinitif. כאן la הופך ל-l' כי appeler מתחיל בתנועה — הגייה חובה.", tip_he:"aller + la/le/les + infinitif · veux la voir · dois les faire · va l'aider." },
    ],
  ...
  exp: [
    [ /* 0 — Opinion */
      { instruction_he:"הבע עמדה על הרשתות החברתיות", prompt_fr:"Selon toi, les réseaux sociaux rapprochent-ils ou éloignent-ils les gens ?", trans_he:"לדעתך, הרשתות החברתיות מקרבות או מרחיקות?", model_fr:"À mon avis, les réseaux sociaux rapprochent les gens qui sont loin, mais peuvent nous éloigner de ceux qui sont à côté. Tout dépend de l'utilisation.", model_he:"לדעתי, הרשתות החברתיות מקרבות אנשים שנמצאים רחוק, אבל יכולות להרחיק אותנו מאלה שנמצאים לידנו. הכל תלוי בשימוש.", keys_fr:["à mon avis","rapprocher","éloigner","tout dépend de"], tip_he:"D'un côté… de l'autre… · À mon avis · Je pense que · Tout dépend de." },
      { instruction_he:"הבע עמדה על הסביבה", prompt_fr:"Penses-tu que les individus peuvent vraiment aider l'environnement ?", trans_he:"לדעתך, האם אנשים יכולים באמת לעזור לסביבה?", model_fr:"Je pense que oui, les gestes quotidiens comptent : recycler, prendre les transports en commun, réduire sa consommation. Mais les entreprises ont une part de responsabilité plus grande.", model_he:"אני חושב שכן, המחוות היומיומיות חשובות: מיחזור, שימוש בתחבורה ציבורית, הפחתת הצריכה. אבל לחברות יש חלק גדול יותר באחריות.", keys_fr:["je pense que","les gestes quotidiens","mais","une part de responsabilité"], tip_he:"Je pense que · certes (כמובן) · mais · cependant (עם זאת)." },
      { instruction_he:"הבע עמדה על הטכנולוגיה", prompt_fr:"La technologie améliore-t-elle notre vie quotidienne ?", trans_he:"האם הטכנולוגיה משפרת את חיינו היומיומיים?", model_fr:"En général, je dirais que oui. La technologie nous facilite la vie, mais elle peut aussi créer une dépendance. Il faut l'utiliser de façon raisonnée.", model_he:"בדרך כלל, הייתי אומר שכן. הטכנולוגיה מקלה על חיינו, אבל היא יכולה גם ליצור תלות. צריך להשתמש בה בצורה מחושבת.", keys_fr:["en général","je dirais que","mais","une dépendance","de façon raisonnée"], tip_he:"en général · il faut + infinitif · de façon raisonnée = בצורה מחושבת." },
    ],
    [ /* 1 — Événement */
      { instruction_he:"ספר על סוף שבוע שהשאיר רושם", prompt_fr:"Raconte un week-end qui t'a marqué.", trans_he:"ספר על סוף שבוע שהשאיר בך רושם.", model_fr:"Le week-end dernier, je suis allé à la montagne avec des amis. Il faisait magnifique et nous avons fait une longue randonnée. Le soir, nous étions épuisés mais heureux.", model_he:"בסוף השבוע שעבר, הלכתי להרים עם חברים. היה נהדר ועשינו טיול ארוך. בערב, היינו עייפים אבל שמחים.", keys_fr:["le week-end dernier","je suis allé","il faisait","nous avons fait","nous étions"], tip_he:"PC לפעולות + imparfait לרקע: il faisait beau · nous étions fatigués." },
      { instruction_he:"ספר על ארוע שחווית", prompt_fr:"Décris un événement récent qui t'a touché ou surpris.", trans_he:"תאר ארוע עדכני שנגע בך או הפתיע אותך.", model_fr:"La semaine dernière, j'ai assisté à un concert de jazz. Je ne m'attendais pas à apprécier autant. L'ambiance était fantastique et les musiciens étaient incroyables.", model_he:"בשבוע שעבר, השתתפתי בקונצרט ג'אז. לא ציפיתי ליהנות כל כך. האווירה הייתה מדהימה והמוזיקאים היו מדהימים.", keys_fr:["j'ai assisté à","je ne m'attendais pas","l'ambiance était","incroyables"], tip_he:"je ne m'attendais pas = לא ציפיתי. l'ambiance = האווירה." },
      { instruction_he:"ספר על חגיגה משפחתית", prompt_fr:"Décris une fête familiale récente.", trans_he:"תאר חגיגה משפחתית שהתקיימה לאחרונה.", model_fr:"Le mois dernier, nous avons fêté l'anniversaire de ma grand-mère. Toute la famille s'était réunie. On a mangé, dansé et ri toute la soirée.", model_he:"בחודש שעבר, חגגנו את יום הולדתה של סבתא שלי. כל המשפחה התכנסה. אכלנו, רקדנו וצחקנו כל הערב.", keys_fr:["nous avons fêté","toute la famille","s'était réunie","on a mangé","toute la soirée"], tip_he:"on a = nous avons (יומיומי) · toute la soirée = כל הערב." },
    ],
    [ /* 2 — Description */
      { instruction_he:"תאר אדם שאתה מכיר", prompt_fr:"Décris une personne que tu admires. Son apparence et sa personnalité.", trans_he:"תאר אדם שאתה מעריך. מראהו ואישיותו.", model_fr:"J'admire beaucoup mon professeur de musique. Il est grand et élégant, avec des cheveux grisonnants. C'est un homme patient et passionné.", model_he:"אני מאוד מעריץ את מורה המוזיקה שלי. הוא גבוה ואלגנטי, עם שיער מאפיר. הוא אדם סבלני ונלהב.", keys_fr:["j'admire","il est","avec des cheveux","c'est un homme","passionné"], tip_he:"apparence: grand/e · brun/e · élégant/e · personnalité: patient/e · généreux/se." },
      { instruction_he:"תאר מקום אהוב", prompt_fr:"Décris un endroit que tu aimes particulièrement.", trans_he:"תאר מקום שאתה אוהב במיוחד.", model_fr:"J'adore la plage de Bat Yam. C'est un endroit calme avec une belle vue sur la mer. Le soir, on peut voir le coucher de soleil, c'est magnifique.", model_he:"אני מאוד אוהב את חוף בת ים. זה מקום שקט עם נוף יפה לים. בערב, אפשר לראות את שקיעת השמש, זה נפלא.", keys_fr:["j'adore","c'est un endroit","avec une belle vue","le soir","magnifique"], tip_he:"avec + description · c'est un endroit où... · on peut y + verb." },
      { instruction_he:"תאר את המנה האהובה עליך", prompt_fr:"Décris ton plat préféré et explique pourquoi tu l'aimes.", trans_he:"תאר את המנה האהובה עליך.", model_fr:"Mon plat préféré, c'est les pâtes à la carbonara. C'est à la fois simple et réconfortant. De plus, ça me rappelle un voyage en Italie.", model_he:"המנה האהובה עלי היא פסטה קרבונרה. זה גם פשוט וגם מנחם. בנוסף, זה מזכיר לי טיול באיטליה.", keys_fr:["mon plat préféré","à la fois","de plus","ça me rappelle"], tip_he:"à la fois... et... · de plus · parce que · ça me rappelle." },
    ],
    [ /* 3 — Comparaison */
      { instruction_he:"השווה שתי ערים", prompt_fr:"Compare deux villes que tu connais.", trans_he:"השווה בין שתי ערים שאתה מכיר.", model_fr:"Tel Aviv est plus moderne et plus animée que Jérusalem. Mais Jérusalem est plus historique et plus calme. Les deux ont leur charme particulier.", model_he:"תל אביב מודרנית ותוססת יותר מירושלים. אבל ירושלים יותר היסטורית ושקטה. לשתיהן יש קסם מיוחד.", keys_fr:["plus ... que","mais","les deux","leur charme"], tip_he:"plus...que · moins...que · aussi...que · les deux (שתיהן)." },
      { instruction_he:"השווה שתי אפשרויות", prompt_fr:"Est-il mieux de travailler en équipe ou seul ? Compare les deux.", trans_he:"מה עדיף: לעבוד בצוות או לבד? השווה.", model_fr:"Travailler en équipe permet de partager les idées et de s'entraider. Travailler seul est plus tranquille et permet de se concentrer. Personnellement, je préfère une combinaison des deux.", model_he:"עבודה בצוות מאפשרת שיתוף רעיונות ועזרה הדדית. עבודה לבד יותר שקטה ומאפשרת ריכוז. באופן אישי, אני מעדיף שילוב של השניים.", keys_fr:["permet de","travailler seul","personnellement","je préfère"], tip_he:"permet de + inf · d'un côté... de l'autre · personnellement." },
      { instruction_he:"השווה שני סגנונות חיים", prompt_fr:"Comparez la vie à la campagne et la vie en ville.", trans_he:"השווה בין חיים בכפר לחיים בעיר.", model_fr:"La vie en ville est pratique : tout est proche. Mais c'est aussi plus stressant et plus bruyant. La campagne est plus calme et plus verte, mais on y manque de services.", model_he:"חיים בעיר הם נוחים: הכל קרוב. אבל זה גם יותר מלחיץ ורועש. הכפר יותר שקט וירוק, אבל חסרים שם שירותים.", keys_fr:["la vie en ville est","mais","la campagne","on y manque de"], tip_he:"pratique (נוח) · stressant (מלחיץ) · manquer de (חסר)." },
    ],
    [ /* 4 — Conseil */
      { instruction_he:"תן עצה לתלמיד חדש", prompt_fr:"Quels conseils donnerais-tu à un élève qui commence le lycée ?", trans_he:"אילו עצות היית נותן לתלמיד שמתחיל תיכון?", model_fr:"Je lui conseillerais de s'organiser dès le début et de ne pas remettre au lendemain. Il devrait aussi participer en classe et ne pas hésiter à poser des questions.", model_he:"הייתי ממליץ לו להתארגן מההתחלה ולא לדחות לאחר כך. הוא גם צריך להשתתף בשיעור ולא לחשוש לשאול שאלות.", keys_fr:["je lui conseillerais de","s'organiser","ne pas remettre","participer","ne pas hésiter"], tip_he:"je te conseille de + inf · tu devrais + inf · il faut que tu + subj." },
      { instruction_he:"תן עצה בריאותית", prompt_fr:"Quels conseils donnerais-tu à quelqu'un qui veut être en meilleure santé ?", trans_he:"אילו עצות היית נותן למישהו שרוצה להיות בריא יותר?", model_fr:"Je lui conseillerais d'abord de faire du sport régulièrement, même 30 minutes par jour. Ensuite, il faudrait réduire le sucre et dormir suffisamment.", model_he:"הייתי ממליץ לו קודם כל לעשות ספורט באופן סדיר, אפילו 30 דקות ביום. אחר כך, צריך להפחית סוכר ולישון מספיק.", keys_fr:["je lui conseillerais","régulièrement","il faudrait","réduire","suffisamment"], tip_he:"régulièrement = באופן סדיר · réduire = להפחית · suffisamment = מספיק." },
      { instruction_he:"תן עצה לנסיעה", prompt_fr:"Quels conseils donnerais-tu à quelqu'un qui visite Paris pour la première fois ?", trans_he:"אילו עצות היית נותן למי שמבקר בפריז בפעם הראשונה?", model_fr:"Je lui conseille de prendre le métro plutôt que le taxi. Il devrait aussi visiter les quartiers moins touristiques comme Montmartre ou le Marais.", model_he:"אני ממליץ לו לקחת את הרכבת התחתית ולא מונית. הוא גם צריך לבקר בשכונות פחות תיירותיות כמו מונמרטר או לה מארה.", keys_fr:["je lui conseille de","plutôt que","il devrait","les quartiers"], tip_he:"je conseille de + inf · plutôt que (במקום) · il devrait (הוא צריך)." },
    ],
    [ /* 5 — Récit */
      { instruction_he:"ספר סיפור בעבר", prompt_fr:"Raconte une aventure ou une anecdote amusante.", trans_he:"ספר הרפתקה או סיפור מצחיק.", model_fr:"Un jour, je me suis perdu dans un quartier inconnu de Paris. Je ne parlais pas français à l'époque. Finalement, un passant m'a aidé avec des gestes.", model_he:"יום אחד, הלכתי לאיבוד בשכונה לא מוכרת בפריז. לא דיברתי צרפתית באותה תקופה. לבסוף, עובר אורח עזר לי בתנועות ידיים.", keys_fr:["un jour","je me suis perdu","je ne parlais pas","finalement","m'a aidé"], tip_he:"un jour (יום אחד) · finalement (לבסוף) · à l'époque (באותה תקופה)." },
      { instruction_he:"ספר על רגע מיוחד", prompt_fr:"Raconte un moment important de ta vie.", trans_he:"ספר על רגע חשוב בחייך.", model_fr:"Le moment le plus important de ma vie a été quand j'ai réussi mon baccalauréat. J'avais travaillé dur pendant des mois et quand j'ai vu les résultats, j'ai pleuré de joie.", model_he:"הרגע החשוב ביותר בחיי היה כשעברתי את הבגרות. עבדתי קשה במשך חודשים, וכשראיתי את התוצאות, בכיתי מרוב שמחה.", keys_fr:["le moment le plus important","j'ai réussi","j'avais travaillé","quand j'ai vu","j'ai pleuré de joie"], tip_he:"plus-que-parfait pour l'arrière-plan: j'avais travaillé · j'avais préparé." },
      { instruction_he:"ספר על חוויה בחו\"ל", prompt_fr:"Raconte une expérience à l'étranger.", trans_he:"ספר על חוויה בחו\"ל.", model_fr:"L'été dernier, je suis allé en France pour la première fois. Tout me semblait différent : la nourriture, le rythme de vie, la façon de parler. J'ai adoré cette expérience.", model_he:"בקיץ שעבר, נסעתי לצרפת בפעם הראשונה. הכל נראה לי שונה: האוכל, קצב החיים, אופן הדיבור. אהבתי את החוויה הזו.", keys_fr:["l'été dernier","pour la première fois","tout me semblait","la façon de","j'ai adoré"], tip_he:"tout me semblait (הכל נראה לי) · la façon de + inf · pour la première fois." },
    ],
  ],
};
...
const BANK_C2 = {
  ...
  exp: [
    [ /* 0 — Dissertation */
      { instruction_he:"מבנה dissertation: d'une part / d'autre part", prompt_fr:"Dans quelle mesure le progrès technique améliore-t-il la condition humaine ? Développez en deux paragraphes.", trans_he:"באיזו מידה ההתקדמות הטכנולוגית משפרת את המצב האנושי? פתחו בשני פסקאות.", model_fr:"D'une part, le progrès technique a indéniablement transformé nos conditions de vie. D'autre part, cette évolution soulève des interrogations quant à la déshumanisation des rapports sociaux.", model_he:"מצד אחד, ההתקדמות הטכנולוגית שינתה ללא ספק את תנאי חיינו. מצד שני, התפתחות זו מעלה שאלות לגבי דה-הומניזציה של היחסים החברתיים.", keys_fr:["d'une part... d'autre part","indéniablement","soulève des interrogations","quant à"], tip_he:"d'une part... d'autre part · certes... cependant · il est vrai que... néanmoins." },
      { instruction_he:"dissertation: conclusion dialectique", prompt_fr:"La liberté est-elle compatible avec la loi ? Rédigez une conclusion en 3-4 phrases.", trans_he:"האם חופש מתיישב עם חוק? כתבו מסקנה ב-3-4 משפטים.", model_fr:"En somme, liberté et loi ne s'opposent pas fondamentalement. La loi, loin d'entraver la liberté, en est la condition même. Sans cadre juridique, la liberté de l'un empiéterait nécessairement sur celle d'autrui.", model_he:"בסך הכל, חירות וחוק אינם מתנגשים ביסודם. החוק, במקום לפגוע בחירות, הוא תנאי הכרחי לה. ללא מסגרת משפטית, חירותו של אחד תפגע בהכרח בחירות הזולת.", keys_fr:["en somme","ne s'opposent pas","loin d'","en est la condition","empiéterait"], tip_he:"en somme · loin de + inf · nécessairement · la condition même de." },
      { instruction_he:"dissertation: introduction — poser la problématique", prompt_fr:"Rédigez une introduction sur : « L'art peut-il changer le monde ? »", trans_he:"כתבו מבוא לנושא: «האם האמנות יכולה לשנות את העולם?»", model_fr:"De tout temps, l'art a été porteur de messages politiques et sociaux. Mais peut-il véritablement transformer la société ? C'est à cette question que nous tenterons de répondre.", model_he:"מתמיד, האמנות הייתה נשאת מסרים פוליטיים וחברתיים. אבל האם היא יכולה באמת לשנות את החברה? זו השאלה שננסה לענות עליה.", keys_fr:["de tout temps","porteur de messages","véritablement","nous tenterons de répondre"], tip_he:"מבוא dissertation: context → question → annonce du plan." },
    ],
    [ /* 1 — Commentaire */
      { instruction_he:"פרשנות ציטוט: Camus", prompt_fr:"Commentez brièvement : « Je me révolte, donc nous sommes. » (Camus)", trans_he:"הגיבו בקצרה: «אני מורד, לכן אנחנו קיימים.» (קאמי)", model_fr:"Camus renverse le cogito cartésien pour affirmer que la révolte n'est pas individuelle, mais le fondement du lien social. En se révoltant, l'individu transcende son moi et crée une solidarité avec autrui.", model_he:"קאמי הופך את הקוגיטו הקרטזיאני כדי לטעון שהמרד אינו אינדיבידואלי אלא ביסוד הקשר החברתי. במרדו, הפרט חורג מן האני שלו ויוצר סולידריות עם הזולת.", keys_fr:["renverse","le cogito","la révolte","transcende","solidarité","autrui"], tip_he:"ניתוח ציטוט: מה הוא אומר? על מה הוא מתבסס? איזו השלכה יש לו?" },
      { instruction_he:"commentaire de texte: repérer le ton", prompt_fr:"Analysez le ton de ce passage : « La machine ne connaît ni pitié ni repos. Elle avance, implacable, vers l'horizon vide de tout sens humain. »", trans_he:"נתחו את הטון של הקטע הזה.", model_fr:"Le ton est pessimiste et même tragique. L'auteur personnifie la machine pour en faire une force hostile. La répétition sonore (« pitié », « implacable ») renforce la sensation d'inéluctabilité.", model_he:"הטון הוא פסימי ואף טרגי. המחבר מאניש את המכונה כדי להפוך אותה לכוח עוין. החזרה הצלילית ('pitié', 'implacable') מחזקת את תחושת הבלתי-נמנע.", keys_fr:["pessimiste","personnifie","répétition","inéluctabilité"], tip_he:"repérer le ton: ironique · lyrique · pessimiste · critique · solennel." },
      { instruction_he:"commentaire: identifier la figure de style", prompt_fr:"Identifiez et expliquez la figure de style dans : « Le temps est un voleur silencieux. »", trans_he:"זהו והסבירו את הדמות הרטורית ב: «הזמן הוא גנב שקט.»", model_fr:"C'est une métaphore : le temps est comparé à un voleur sans utiliser « comme ». Cela suggère que le temps nous dérobe insensiblement notre vie, nos souvenirs, notre jeunesse.", model_he:"זוהי מטפורה: הזמן מושווה לגנב מבלי להשתמש ב-'כמו'. הדבר מרמז שהזמן גוזל מאיתנו בהדרגה את חיינו, זיכרונותינו ועלומינו.", keys_fr:["métaphore","comparé à","sans utiliser","dérobe insensiblement"], tip_he:"métaphore (ללא comme) · comparaison (עם comme) · personnification · oxymore." },
    ],
    [ /* 2 — Thèse/Antithèse */
      { instruction_he:"thèse: טיעון תומך", prompt_fr:"Formulez une thèse en faveur du travail à distance.", trans_he:"נסחו טענה בעד עבודה מרחוק.", model_fr:"Le télétravail favorise l'autonomie et réduit le temps de transport, permettant aux salariés de gagner en qualité de vie et en productivité.", model_he:"עבודה מרחוק מקדמת אוטונומיה ומפחיתה זמן נסיעה, ומאפשרת לעובדים לשפר את איכות חייהם ואת פריון עבודתם.", keys_fr:["favorise","réduit","permettant","qualité de vie","productivité"], tip_he:"thèse: sujet + verbe fort + argument + exemple/conséquence." },
      { instruction_he:"antithèse: טיעון מנוגד", prompt_fr:"Formulez une antithèse contre le travail à distance.", trans_he:"נסחו טענה נגד עבודה מרחוק.", model_fr:"Cependant, le télétravail isole les employés, érode la cohésion d'équipe et brouille les frontières entre vie professionnelle et vie privée.", model_he:"עם זאת, עבודה מרחוק מבדלת עובדים, שוחקת את הגיבוש הצוותי ומטשטשת את הגבולות בין חיי עבודה לחיים פרטיים.", keys_fr:["cependant","isole","érode","brouille","frontières"], tip_he:"antithèse: cependant · en revanche · or · néanmoins + טיעון מנוגד." },
      { instruction_he:"synthèse: עמדה מאוזנת", prompt_fr:"Proposez une synthèse sur le travail à distance.", trans_he:"הציעו סינתזה על עבודה מרחוק.", model_fr:"En définitive, il convient d'adopter une approche hybride : le télétravail partiel préserve la flexibilité tout en maintenant le lien social indispensable au bien-être collectif.", model_he:"בסופו של דבר, ראוי לאמץ גישה היברידית: עבודה מרחוק חלקית שומרת על גמישות תוך שמירה על הקשר החברתי ההכרחי לרווחה הקולקטיבית.", keys_fr:["en définitive","il convient d'","hybride","tout en maintenant","indispensable"], tip_he:"synthèse: en définitive · au final · il convient de · une approche équilibrée." },
    ],
    [ /* 3 — Analyse */
      { instruction_he:"ניתוח: בינה מלאכותית — הזדמנות או איום?", prompt_fr:"L'intelligence artificielle représente-t-elle une menace ou une opportunité ? Nuancez.", trans_he:"האם בינה מלאכותית מהווה איום או הזדמנות? הדגישו גוונים.", model_fr:"Loin d'une opposition binaire, l'IA exige une lecture nuancée. Si ses applications médicales ouvrent des perspectives inédites, le risque d'instrumentalisation à des fins de surveillance demeure préoccupant.", model_he:"הרחק מניגוד בינארי, הבינה המלאכותית דורשת קריאה מדוקדקת. אם יישומיה הרפואיים פותחים אפקים חדשים, הסיכון לניצולה לצרכי ניטור נותר מדאיג.", keys_fr:["loin d'une opposition","exige une lecture nuancée","ouvrent des perspectives","demeure préoccupant"], tip_he:"il serait réducteur de · la réalité est plus complexe · il convient de distinguer." },
      { instruction_he:"ניתוח: השפעת הרשתות החברתיות", prompt_fr:"Analysez les effets des réseaux sociaux sur la démocratie.", trans_he:"נתחו את השפעות הרשתות החברתיות על הדמוקרטיה.", model_fr:"D'un côté, les réseaux sociaux facilitent la mobilisation citoyenne. De l'autre, ils favorisent la désinformation et les chambres d'écho, fragmentant l'espace public.", model_he:"מצד אחד, הרשתות החברתיות מקלות על גיוס אזרחי. מצד שני, הן מטפחות דיסאינפורמציה ותאי הד, מפרקות את המרחב הציבורי.", keys_fr:["d'un côté","de l'autre","facilitent","désinformation","chambres d'écho","fragmentant"], tip_he:"d'un côté · de l'autre · par ailleurs · en outre · cela étant." },
      { instruction_he:"ניתוח: מגבלות וסיכויים", prompt_fr:"Analysez les limites et opportunités de l'éducation en ligne.", trans_he:"נתחו את המגבלות וההזדמנויות של לימוד מקוון.", model_fr:"Si l'éducation en ligne offre une accessibilité accrue, elle présente des lacunes en termes d'interaction sociale et de suivi individualisé. Son potentiel reste néanmoins considérable.", model_he:"אם החינוך המקוון מציע נגישות מוגברת, יש בו חסרים מבחינת אינטראקציה חברתית ומעקב אינדיבידואלי. עם זאת, פוטנציאלו נותר ניכר.", keys_fr:["si","offre","présente des lacunes","en termes de","néanmoins"], tip_he:"si (= bien que) · présente des lacunes (יש לה חסרונות) · reste néanmoins." },
    ],
    [ /* 4 — Nuance */
      { instruction_he:"גוון עמדה: certes / mais", prompt_fr:"Nuancez cette affirmation : « La technologie détruit le lien social. »", trans_he:"גוונו את הטענה: «הטכנולוגיה הורסת את הקשר החברתי.»", model_fr:"Certes, les écrans peuvent substituer aux interactions réelles. Mais ils créent aussi de nouveaux liens entre personnes éloignées. Il serait réducteur de condamner la technologie sans distinguer ses usages.", model_he:"אכן, המסכים יכולים להחליף אינטראקציות אמיתיות. אבל הם גם יוצרים קשרים חדשים בין אנשים מרוחקים. יהיה מצמצם לגנות את הטכנולוגיה מבלי להבדיל בין שימושיה.", keys_fr:["certes","mais","il serait réducteur de","sans distinguer"], tip_he:"certes... mais · il est vrai que... néanmoins · on peut admettre que... cependant." },
      { instruction_he:"גוון: להציג שני היבטים", prompt_fr:"Nuancez : « La mondialisation est une chance pour tous. »", trans_he:"גוונו: «הגלובליזציה היא הזדמנות לכולם.»", model_fr:"Si la mondialisation a permis à des millions de sortir de la pauvreté, elle a également creusé les inégalités au sein des sociétés et fragilisé les cultures locales.", model_he:"אם הגלובליזציה אפשרה למיליונים לצאת מעוני, היא גם הרחיקה פערים בתוך החברות ופגעה בתרבויות מקומיות.", keys_fr:["si ... a permis","elle a également","creusé les inégalités","fragilisé"], tip_he:"si + avantage → elle a également + désavantage. Ne pas oublier la nuance!" },
      { instruction_he:"גוון: הוספת פרספקטיבה", prompt_fr:"Ajoutez une nuance à : « Le travail manuel est moins valorisé que le travail intellectuel. »", trans_he:"הוסיפו גוון: «עבודה ידנית מוערכת פחות מעבודה אינטלקטואלית.»", model_fr:"Ce constat mérite d'être nuancé selon les époques et les cultures. Dans certaines sociétés, le savoir-faire artisanal est hautement respecté. La hiérarchie des métiers varie selon le contexte.", model_he:"תצפית זו ראויה לנואנסים בהתאם לתקופות ולתרבויות. בחברות מסוימות, המיומנות האומנותית מוערכת מאוד. ההיררכיה של המקצועות משתנה לפי ההקשר.", keys_fr:["mérite d'être nuancé","selon","savoir-faire artisanal","la hiérarchie varie"], tip_he:"mérite d'être nuancé · selon les contextes · il convient de distinguer · cela varie selon." },
    ],
    [ /* 5 — Maîtrise */
      { instruction_he:"שליטה: ביטוי ספונטני על נושא עכשווי", prompt_fr:"Exprimez-vous librement sur l'avenir du français dans le monde.", trans_he:"הביעו עצמכם בחופשיות על עתיד הצרפתית בעולם.", model_fr:"Le français, parlé par plus de 300 millions de locuteurs, connaît une expansion notable en Afrique. Loin de son déclin annoncé, il reste une langue de culture et de diplomatie, adaptant son usage aux réalités contemporaines.", model_he:"הצרפתית, הנדברת על ידי יותר מ-300 מיליון דוברים, מתרחבת בצורה ניכרת באפריקה. רחוקה מהדעיכה שנצפתה לה, היא נשארת שפת תרבות ודיפלומטיה, ומתאימה את השימוש בה למציאות העכשווית.", keys_fr:["locuteurs","expansion","loin de","reste une langue de","adaptant"], tip_he:"C2: phrases longues · participiales · registre formel · vocabulaire précis." },
      { instruction_he:"שליטה: improvisation sur אתיקה", prompt_fr:"La fin justifie-t-elle les moyens ? Développez en 5 phrases.", trans_he:"האם המטרה מקדשת את האמצעים? פתחו ב-5 משפטים.", model_fr:"Cette formule, attribuée à Machiavel, soulève une question éthique fondamentale. Si certains actes répréhensibles peuvent sembler justifiés par leurs effets, cette logique ouvre la voie à toutes les dérives. Une société ne peut prospérer sur un relativisme moral absolu.", model_he:"ניסוח זה, המיוחס למקיאוולי, מעלה שאלה אתית יסודית. אם מעשים מגונים מסוימים עשויים להיראות מוצדקים על ידי השפעותיהם, היגיון זה פותח פתח לכל ניוון. חברה אינה יכולה לשגשג על יחסיות מוסרית מוחלטת.", keys_fr:["soulève","répréhensibles","ouvre la voie","dérives","relativisme moral"], tip_he:"attribuée à · soulève une question · ouvre la voie à · toutes les dérives." },
      { instruction_he:"שליטה: אנליזה פתוחה", prompt_fr:"« Parler, c'est agir. » Développez cette idée.", trans_he:"«לדבר זה לפעול.» פתחו רעיון זה.", model_fr:"Selon Austin et les théories des actes de langage, la parole n'est pas un simple reflet de la pensée : elle produit des effets dans le monde. Promettre, ordonner, déclarer — ces actes transforment la réalité.", model_he:"לפי אוסטין ותיאוריות מעשי הדיבור, הדיבור אינו רק השתקפות של המחשבה: הוא מייצר השפעות בעולם. להבטיח, לפקד, להכריז — מעשים אלה משנים את המציאות.", keys_fr:["actes de langage","produit des effets","promettre","ordonner","transforment la réalité"], tip_he:"selon + philosophe/théorie · la parole n'est pas seulement · elle produit / génère / transforme." },
    ],
  ],
};
...
const BANK_B2 = {
  ...
  exp: [
    [ /* 0 — Société */
      { instruction_he:"הבע עמדה: עבודה מרחוק", prompt_fr:"Que penses-tu du télétravail ? Donne ton avis en deux phrases.", trans_he:"מה דעתך על עבודה מרחוק?", model_fr:"Personnellement, je trouve que le télétravail offre une grande flexibilité. Cependant, il peut créer un sentiment d'isolement, c'est pourquoi je préfère un rythme hybride.", model_he:"באופן אישי, אני חושב שעבודה מרחוק מציעה גמישות רבה. עם זאת, היא עשויה ליצור תחושת בידוד, ולכן אני מעדיף קצב היברידי.", keys_fr:["personnellement","je trouve que","cependant","c'est pourquoi"], tip_he:"personnellement · je trouve que · cependant · c'est pourquoi." },
      { instruction_he:"הבע עמדה: רשתות חברתיות", prompt_fr:"Les réseaux sociaux : avantage ou danger pour la société ?", trans_he:"רשתות חברתיות: יתרון או סכנה לחברה?", model_fr:"À mon avis, les réseaux sociaux rapprochent les gens qui sont loin, mais peuvent nous éloigner de ceux qui sont à côté. Tout dépend de la manière dont on les utilise.", model_he:"לדעתי, הרשתות החברתיות מקרבות אנשים שנמצאים רחוק, אבל יכולות להרחיק אותנו מאלה שסמוכים לנו. הכל תלוי באופן שבו משתמשים בהן.", keys_fr:["à mon avis","rapprocher","éloigner","tout dépend de"], tip_he:"D'un côté… de l'autre… · à mon avis · tout dépend de." },
      { instruction_he:"הבע עמדה: שינויי אקלים", prompt_fr:"Les individus peuvent-ils vraiment aider l'environnement ?", trans_he:"האם אנשים יכולים באמת לעזור לסביבה?", model_fr:"Je pense que oui : recycler, consommer moins, prendre les transports en commun — ces gestes comptent. Mais la responsabilité principale incombe aux entreprises et aux gouvernements.", model_he:"אני חושב שכן: למחזר, לצרוך פחות, לקחת תחבורה ציבורית — המחוות האלה חשובות. אבל האחריות העיקרית מוטלת על חברות ועל ממשלות.", keys_fr:["je pense que","ces gestes comptent","mais","incombe aux"], tip_he:"ces gestes comptent (המעשים האלה חשובים) · incombe à (מוטלת על)." },
    ],
    [ /* 1 — Culture */
      { instruction_he:"תאר מנה אהובה", prompt_fr:"Décris ton plat préféré et explique pourquoi tu l'aimes.", trans_he:"תאר את המנה האהובה עליך.", model_fr:"Mon plat préféré, c'est sans doute les pâtes à la carbonara. J'apprécie ce plat parce qu'il est simple et réconfortant. De plus, il me rappelle un voyage en Italie.", model_he:"המנה האהובה עלי היא כנראה פסטה קרבונרה. אני מעריך מנה זו כי היא פשוטה ומנחמת. בנוסף, היא מזכירה לי טיול באיטליה.", keys_fr:["sans doute","j'apprécie parce que","à la fois","de plus","il me rappelle"], tip_he:"à la fois · de plus · parce que · il me rappelle." },
      { instruction_he:"תאר יום סוף שבוע אידיאלי", prompt_fr:"Décris ta journée de week-end idéale.", trans_he:"תאר את יום סוף השבוע האידיאלי שלך.", model_fr:"Ma journée idéale commencerait par un petit-déjeuner tranquille. Ensuite, je me promènerais en ville, puis je retrouverais des amis. Le soir, je regarderais un film.", model_he:"היום האידיאלי שלי יתחיל בארוחת בוקר שקטה. אחר כך, אטייל בעיר, ואז אפגש עם חברים. בערב, אצפה בסרט.", keys_fr:["commencerait par","ensuite","puis","le soir"], tip_he:"conditionnel: commencerait · je me promènerais · je retrouverais." },
      { instruction_he:"השווה שתי תרבויות", prompt_fr:"Compare deux pays ou cultures que tu connais.", trans_he:"השווה בין שתי מדינות או תרבויות שאתה מכיר.", model_fr:"Israël et la France ont des cultures très différentes. En Israël, on est direct et informel. En France, on valorise davantage la politesse formelle et la gastronomie. Les deux ont leur charme.", model_he:"ישראל וצרפת הן בעלות תרבויות שונות מאוד. בישראל, אנשים ישירים ולא פורמליים. בצרפת, מעריכים יותר נימוס פורמלי וגסטרונומיה. לשתיהן יש קסם.", keys_fr:["en Israël","en France","davantage","les deux ont leur charme"], tip_he:"en ... on + verbe · davantage (יותר) · les deux · à l'inverse." },
    ],
    [ /* 2 — Argumentation */
      { instruction_he:"מסגרת טיעון: ב-2 טיעונים", prompt_fr:"Donnez deux arguments pour ou contre la semaine de 4 jours.", trans_he:"תנו שני טיעונים בעד או נגד שבוע עבודה בן 4 ימים.", model_fr:"Premièrement, la semaine de 4 jours améliore le bien-être des employés et réduit l'absentéisme. Deuxièmement, elle peut augmenter la productivité en concentrant les efforts.", model_he:"ראשית, שבוע עבודה של 4 ימים משפר את רווחת העובדים ומפחית היעדרויות. שנית, הוא עשוי להגביר פריון על ידי ריכוז המאמצים.", keys_fr:["premièrement","deuxièmement","améliore","réduit","augmenter"], tip_he:"premièrement · deuxièmement · en outre (בנוסף) · de plus (יתרה מזאת)." },
      { instruction_he:"תן עצה: ללמוד צרפתית", prompt_fr:"Quels conseils donnerais-tu à quelqu'un qui commence le français ?", trans_he:"אילו עצות היית נותן למי שמתחיל ללמוד צרפתית?", model_fr:"Je lui conseillerais d'écouter du français tous les jours, même quelques minutes. Il ne faudrait pas avoir peur de faire des erreurs, car c'est en se trompant qu'on apprend.", model_he:"הייתי ממליץ לו להאזין לצרפתית כל יום, אפילו כמה דקות. לא כדאי לפחד לעשות טעויות, כי זה דרך הטעויות שלומדים.", keys_fr:["je lui conseillerais","ne pas avoir peur","c'est en se trompant que"], tip_he:"je lui conseille de + inf · il faudrait que · c'est en + gérondif que." },
      { instruction_he:"בנה טיעון: conditionnel", prompt_fr:"Si tu étais président(e), quelle loi voterais-tu en premier ?", trans_he:"אם היית נשיא/ה, על איזה חוק היית מצביע ראשון?", model_fr:"Si j'étais président, je voterais d'abord une loi obligatoire sur le recyclage. Je pense que l'urgence climatique exige des mesures concrètes et immédiates.", model_he:"אילו הייתי נשיא, הייתי מצביע תחילה על חוק מחייב בנושא מיחזור. אני חושב שדחיפות האקלים דורשת צעדים קונקרטיים ומיידיים.", keys_fr:["si j'étais","je voterais","je pense que","l'urgence climatique","exige"], tip_he:"Si + imparfait → conditionnel. je voterais · je créerais · j'imposerais." },
    ],
    [ /* 3 — Nuancer */
      { instruction_he:"גוון עמדה: הוסף certes/mais", prompt_fr:"Nuancez : « La technologie détruit le lien social. »", trans_he:"גוונו: «הטכנולוגיה הורסת את הקשר החברתי.»", model_fr:"Certes, les écrans peuvent substituer aux interactions réelles. Mais ils créent aussi de nouveaux liens entre personnes éloignées. Il serait réducteur de condamner la technologie.", model_he:"אכן, המסכים יכולים להחליף אינטראקציות אמיתיות. אבל הם גם יוצרים קשרים חדשים בין אנשים מרוחקים. יהיה מצמצם לגנות את הטכנולוגיה.", keys_fr:["certes","mais","il serait réducteur de"], tip_he:"certes... mais · il est vrai que... néanmoins · on peut admettre que... cependant." },
      { instruction_he:"גוון: שני היבטים", prompt_fr:"Nuancez : « La mondialisation est une chance pour tous. »", trans_he:"גוונו: «הגלובליזציה היא הזדמנות לכולם.»", model_fr:"Si la mondialisation a permis à des millions de sortir de la pauvreté, elle a également creusé les inégalités au sein des sociétés et fragilisé les cultures locales.", model_he:"אם הגלובליזציה אפשרה למיליונים לצאת מעוני, היא גם הרחיקה פערים בתוך החברות ופגעה בתרבויות מקומיות.", keys_fr:["si ... a permis","elle a également","creusé les inégalités","fragilisé"], tip_he:"si (avantage) → elle a également (désavantage). Ne pas oublier la nuance!" },
      { instruction_he:"גוון: הפרדה בין היבטים", prompt_fr:"Nuancez le rôle des réseaux sociaux dans les mouvements citoyens.", trans_he:"גוונו את תפקיד הרשתות החברתיות בתנועות אזרחיות.", model_fr:"D'un côté, les réseaux sociaux ont facilité des mobilisations historiques. De l'autre, ils peuvent aussi propager des fausses informations et diviser. Tout dépend de l'usage.", model_he:"מצד אחד, הרשתות החברתיות הקלו על גיוסים היסטוריים. מצד שני, הן גם עשויות להפיץ מידע כוזב ולפלג. הכל תלוי בשימוש.", keys_fr:["d'un côté","de l'autre","facilité","propager","tout dépend de l'usage"], tip_he:"d'un côté · de l'autre · par ailleurs · tout dépend de." },
    ],
    [ /* 4 — Convaincre */
      { instruction_he:"שכנע: הצג מסקנה", prompt_fr:"Rédigez une conclusion convaincante sur l'importance des langues étrangères.", trans_he:"כתבו מסקנה משכנעת על חשיבות שפות זרות.", model_fr:"En définitive, apprendre une langue étrangère n'est pas seulement un atout professionnel : c'est une ouverture sur le monde, un enrichissement culturel et humain irremplaçable.", model_he:"בסופו של דבר, לימוד שפה זרה אינו רק יתרון מקצועי: זוהי פתיחות לעולם, העשרה תרבותית ואנושית שאין לה תחליף.", keys_fr:["en définitive","n'est pas seulement","c'est une ouverture","enrichissement","irremplaçable"], tip_he:"en définitive · n'est pas seulement... c'est aussi · irremplaçable." },
      { instruction_he:"שכנע: הגב להתנגדות", prompt_fr:"Quelqu'un dit : « L'art n'est pas utile. » Comment répondez-vous ?", trans_he:"מישהו אומר: «אמנות אינה שימושית.» כיצד תגיבו?", model_fr:"Je comprends ce point de vue, mais l'utilité n'est pas la seule valeur. L'art nourrit l'esprit, développe la créativité et offre un espace de réflexion que rien d'autre ne peut remplacer.", model_he:"אני מבין נקודת מבט זו, אבל תועלתיות אינה הערך היחיד. האמנות מזינה את הרוח, מפתחת יצירתיות ומציעה מרחב לחשיבה שדבר אחר לא יכול להחליפו.", keys_fr:["je comprends","mais","nourrit l'esprit","développe","rien d'autre ne peut remplacer"], tip_he:"je comprends... mais · loin de là · bien au contraire · néanmoins." },
      { instruction_he:"שכנע: תמוך בעמדה", prompt_fr:"Convainquez quelqu'un d'apprendre le français.", trans_he:"שכנעו מישהו ללמוד צרפתית.", model_fr:"Le français est une langue internationale parlée sur cinq continents. En apprenant le français, vous accédez à une culture riche, à des opportunités professionnelles et à des relations humaines élargies.", model_he:"הצרפתית היא שפה בינלאומית הנדברת בחמש יבשות. בלמידת הצרפתית, אתם מקבלים גישה לתרבות עשירה, להזדמנויות מקצועיות ולקשרים אנושיים מורחבים.", keys_fr:["internationale","cinq continents","en apprenant","opportunités","relations humaines élargies"], tip_he:"en + gérondif = בזכות + infinitif · vous accédez à · une culture riche." },
    ],
    [ /* 5 — Improviser */
      { instruction_he:"אימפרוביזציה: תגובה היפותטית", prompt_fr:"Comment réagirais-tu si un ami annulait à la dernière minute ?", trans_he:"איך היית מגיב אם חבר מבטל ברגע האחרון?", model_fr:"Je serais un peu déçu, mais je comprendrais s'il avait une bonne raison. Je lui proposerais de reporter à un autre jour plutôt que de me fâcher.", model_he:"הייתי מאוכזב קצת, אבל הייתי מבין אם היה לו סיבה טובה. הייתי מציע לו לדחות ליום אחר במקום לכעוס.", keys_fr:["je serais","je comprendrais","je lui proposerais","plutôt que de"], tip_he:"conditionnel présent: je serais · je comprendrais · je proposerais." },
      { instruction_he:"אימפרוביזציה: מיומנות שתרצה", prompt_fr:"Si tu pouvais maîtriser une compétence instantanément, laquelle choisirais-tu ?", trans_he:"אם יכולת לרכוש מיומנות אחת מיידית, איזו היית בוחר?", model_fr:"Si je pouvais maîtriser une compétence, je choisirais de jouer du piano. Ce serait une source de joie quotidienne et cela me permettrait d'exprimer des émotions autrement.", model_he:"אם יכולתי לשלוט במיומנות אחת, הייתי בוחר לנגן על הפסנתר. זה יהיה מקור לשמחה יומיומית וייאפשר לי לבטא רגשות בדרך אחרת.", keys_fr:["si je pouvais","je choisirais","ce serait","cela me permettrait"], tip_he:"Si + imparfait → conditionnel: je choisirais · ce serait · je pourrais." },
      { instruction_he:"אימפרוביזציה: עצה לדמות היסטורית", prompt_fr:"Quels conseils donnerais-tu à un jeune Napoléon ?", trans_he:"אילו עצות היית נותן לנפוליאון הצעיר?", model_fr:"Je lui conseillerais d'écouter davantage ses conseillers et de ne pas laisser l'orgueil dicter ses décisions militaires. La modération est souvent plus puissante que l'ambition débridée.", model_he:"הייתי ממליץ לו להקשיב יותר ליועציו ולא לתת לגאווה להכתיב את החלטותיו הצבאיות. המתינות לעתים קרובות חזקה יותר מאשר שאפתנות פרועה.", keys_fr:["je lui conseillerais","d'écouter davantage","ne pas laisser","l'orgueil","la modération"], tip_he:"je lui conseillerais de · ne pas laisser + N + inf · la modération." },
    ],
  ],
};
...
const BANK_C1 = {
  ...
  exp: [
    [ /* 0 — Débattre */
      { instruction_he:"הבע עמדה עם ניגוד", prompt_fr:"Que penses-tu du télétravail ? Donne ton avis en deux phrases.", trans_he:"מה דעתך על עבודה מרחוק?", model_fr:"Personnellement, je trouve que le télétravail offre une grande flexibilité. Cependant, il peut créer un sentiment d'isolement, c'est pourquoi je préfère un rythme hybride.", model_he:"באופן אישי, אני חושב שעבודה מרחוק מציעה גמישות רבה. עם זאת, היא עשויה ליצור תחושת בידוד, ולכן אני מעדיף קצב היברידי.", keys_fr:["personnellement","je trouve que","cependant","c'est pourquoi"], tip_he:"je trouve que · cependant · c'est pourquoi + עמדה." },
      { instruction_he:"debate: תמיכה בצד מסוים", prompt_fr:"Défendez l'idée que l'école devrait enseigner la philosophie dès l'école primaire.", trans_he:"הגנו על הרעיון שיש ללמד פילוסופיה כבר בבית ספר יסודי.", model_fr:"Enseigner la philosophie dès le plus jeune âge développe la pensée critique et la capacité à raisonner. De plus, cela habitue les enfants à questionner le monde et à formuler des arguments.", model_he:"הוראת פילוסופיה כבר מגיל צעיר מפתחת חשיבה ביקורתית ויכולת להסיק מסקנות. בנוסף, הדבר מרגיל ילדים לתהות על העולם ולנסח טיעונים.", keys_fr:["dès le plus jeune âge","la pensée critique","de plus","habitue à","formuler des arguments"], tip_he:"dès (כבר מ-) · développe · habitue à · cela permet de." },
      { instruction_he:"debate: ניסוח עמדה מנומקת", prompt_fr:"Pensez-vous que l'art devrait être subventionné par l'État ?", trans_he:"לדעתכם, האם המדינה צריכה לסבסד אמנות?", model_fr:"Je pense que oui. L'art joue un rôle social essentiel en offrant un espace de réflexion collective. Sans soutien public, seuls les artistes issus de milieux aisés pourraient survivre.", model_he:"אני חושב שכן. האמנות ממלאת תפקיד חברתי חיוני בהציעה מרחב לחשיבה קולקטיבית. ללא תמיכה ציבורית, רק אמנים מרקע אמיד יוכלו לשרוד.", keys_fr:["je pense que","joue un rôle essentiel","sans soutien public","milieux aisés"], tip_he:"joue un rôle (ממלא תפקיד) · sans + GN, + conditionnel · issus de." },
    ],
    [ /* 1 — Nuancer */
      { instruction_he:"גוון עמדה: הטכנולוגיה", prompt_fr:"Nuancez : « La technologie détruit le lien social. »", trans_he:"גוונו: «הטכנולוגיה הורסת את הקשר החברתי.»", model_fr:"Certes, les écrans peuvent substituer aux interactions réelles. Mais ils créent aussi de nouveaux liens. Il serait réducteur de condamner la technologie sans distinguer ses usages.", model_he:"אכן, המסכים יכולים להחליף אינטראקציות אמיתיות. אבל הם גם יוצרים קשרים חדשים. יהיה מצמצם לגנות את הטכנולוגיה מבלי להבדיל בין שימושיה.", keys_fr:["certes","mais","il serait réducteur de","sans distinguer"], tip_he:"certes... mais · il est vrai que... néanmoins · on peut admettre que... cependant." },
      { instruction_he:"גוון: ניגוד מבוסס", prompt_fr:"Nuancez : « La mondialisation est une chance pour tous. »", trans_he:"גוונו: «הגלובליזציה היא הזדמנות לכולם.»", model_fr:"Si la mondialisation a permis à des millions de sortir de la pauvreté, elle a aussi creusé les inégalités et fragilisé les cultures locales.", model_he:"אם הגלובליזציה אפשרה למיליונים לצאת מעוני, היא גם הרחיקה פערים ופגעה בתרבויות מקומיות.", keys_fr:["si ... a permis","elle a aussi","creusé les inégalités","fragilisé"], tip_he:"si (avantage) → elle a aussi (désavantage)." },
      { instruction_he:"גוון: הוסף פרספקטיבה", prompt_fr:"Ajoutez une nuance à : « Le travail est source d'épanouissement. »", trans_he:"הוסיפו גוון: «העבודה היא מקור לפיתוח אישי.»", model_fr:"Cette affirmation mérite d'être nuancée. Si certains trouvent dans leur travail un épanouissement réel, d'autres le vivent comme une contrainte ou une source de stress.", model_he:"טענה זו ראויה לנואנסים. אם חלק מוצאים בעבודתם שגשוג אמיתי, אחרים חווים אותה כאילוץ או מקור ללחץ.", keys_fr:["mérite d'être nuancée","si certains","d'autres","une contrainte"], tip_he:"mérite d'être nuancé · si certains... d'autres · selon le contexte." },
    ],
    [ /* 2 — Négocier */
      { instruction_he:"ניהול משא ומתן: הצעה מנומסת", prompt_fr:"Proposez une solution de compromis dans une situation de conflit.", trans_he:"הציעו פתרון פשרה במצב קונפליקט.", model_fr:"Je comprends votre point de vue. Cependant, je vous propose une solution intermédiaire : nous pourrions partager les responsabilités de façon équitable.", model_he:"אני מבין את נקודת מבטכם. עם זאת, אני מציע לכם פתרון ביניים: נוכל לחלק את האחריות בצורה שוויונית.", keys_fr:["je comprends","cependant","je vous propose","une solution intermédiaire","de façon équitable"], tip_he:"je comprends · cependant · je vous propose · une solution intermédiaire." },
      { instruction_he:"משא ומתן: הצגת תנאים", prompt_fr:"Exposez vos conditions dans une négociation professionnelle.", trans_he:"הציגו את תנאיכם במשא ומתן מקצועי.", model_fr:"Je suis prêt à accepter cette mission, à condition que le délai soit prolongé de deux semaines et que les ressources nécessaires soient fournies.", model_he:"אני מוכן לקבל על עצמי את המשימה הזו, בתנאי שהמועד יוארך בשבועיים ושהמשאבים הדרושים יסופקו.", keys_fr:["je suis prêt à","à condition que","le délai soit prolongé","les ressources soient fournies"], tip_he:"je suis prêt à · à condition que + subjonctif · à moins que." },
      { instruction_he:"משא ומתן: השגת הסכמה", prompt_fr:"Comment concluriez-vous une négociation réussie ?", trans_he:"כיצד הייתם מסיימים משא ומתן מוצלח?", model_fr:"En définitive, nous avons trouvé un terrain d'entente qui satisfait les deux parties. Je vous remercie de votre flexibilité et j'espère que cette collaboration sera fructueuse.", model_he:"בסופו של דבר, מצאנו הסכמה שמספקת את שני הצדדים. אני מודה לכם על גמישותכם ומקווה שהשיתוף פעולה הזה יהיה פורה.", keys_fr:["en définitive","un terrain d'entente","qui satisfait","je vous remercie","fructueuse"], tip_he:"trouver un terrain d'entente · satisfaire les deux parties · être fructueux." },
    ],
    [ /* 3 — Analyser */
      { instruction_he:"ניתוח: בינה מלאכותית", prompt_fr:"L'intelligence artificielle représente-t-elle une menace ou une opportunité ? Nuancez.", trans_he:"האם בינה מלאכותית מהווה איום או הזדמנות?", model_fr:"Loin d'une opposition binaire, l'IA exige une lecture nuancée. Si ses applications médicales ouvrent des perspectives, le risque de surveillance demeure préoccupant.", model_he:"הרחק מניגוד בינארי, הבינה המלאכותית דורשת קריאה מדוקדקת. אם יישומיה הרפואיים פותחים אפקים, הסיכון של ניטור נותר מדאיג.", keys_fr:["loin d'une opposition","exige une lecture nuancée","ouvrent des perspectives","demeure préoccupant"], tip_he:"loin d'une opposition · exige une lecture nuancée · demeure préoccupant." },
      { instruction_he:"ניתוח: השפעת הרשתות על הדמוקרטיה", prompt_fr:"Analysez les effets des réseaux sociaux sur la démocratie.", trans_he:"נתחו את השפעות הרשתות החברתיות על הדמוקרטיה.", model_fr:"D'un côté, les réseaux facilitent la mobilisation citoyenne. De l'autre, ils favorisent la désinformation et les chambres d'écho, fragmentant l'espace public.", model_he:"מצד אחד, הרשתות מקלות על גיוס אזרחי. מצד שני, הן מטפחות דיסאינפורמציה ותאי הד, מפרקות את המרחב הציבורי.", keys_fr:["d'un côté","de l'autre","facilitent","désinformation","chambres d'écho"], tip_he:"d'un côté · de l'autre · par ailleurs · en outre." },
      { instruction_he:"ניתוח: ספרות ומציאות", prompt_fr:"Dans quelle mesure la littérature peut-elle changer notre vision du monde ?", trans_he:"באיזו מידה הספרות יכולה לשנות את השקפתנו על העולם?", model_fr:"La littérature, en nous plongeant dans d'autres existences, élargit notre empathie. En lisant Proust ou Camus, on perçoit la réalité sous un angle inédit.", model_he:"הספרות, בטובלה אותנו בקיומים אחרים, מרחיבה את האמפתיה שלנו. בקריאת פרוסט או קאמי, אנו תופסים את המציאות מזווית חדשה.", keys_fr:["en nous plongeant","élargit notre empathie","sous un angle inédit","percevoir"], tip_he:"en + gérondif (= על ידי) · élargir (להרחיב) · sous un angle inédit." },
    ],
    [ /* 4 — Convaincre */
      { instruction_he:"שכנע: חשיבות הצרפתית", prompt_fr:"Rédigez une conclusion convaincante sur l'importance des langues étrangères.", trans_he:"כתבו מסקנה משכנעת על חשיבות שפות זרות.", model_fr:"En définitive, apprendre une langue étrangère n'est pas seulement un atout professionnel : c'est une ouverture sur le monde et un enrichissement humain irremplaçable.", model_he:"בסופו של דבר, לימוד שפה זרה אינו רק יתרון מקצועי: זוהי פתיחות לעולם והעשרה אנושית שאין לה תחליף.", keys_fr:["en définitive","n'est pas seulement","c'est une ouverture","enrichissement","irremplaçable"], tip_he:"en définitive · n'est pas seulement... c'est aussi · irremplaçable." },
      { instruction_he:"שכנע: תגובה להתנגדות", prompt_fr:"Quelqu'un dit : « L'art n'est pas utile. » Comment répondez-vous ?", trans_he:"מישהו אומר: «אמנות אינה שימושית.» כיצד תגיבו?", model_fr:"Je comprends ce point de vue, mais l'utilité n'est pas la seule valeur. L'art nourrit l'esprit et développe la créativité — une compétence essentielle aujourd'hui.", model_he:"אני מבין נקודת מבט זו, אבל תועלתיות אינה הערך היחיד. האמנות מזינה את הרוח ומפתחת יצירתיות — מיומנות חיונית כיום.", keys_fr:["je comprends","mais","nourrit l'esprit","développe","essentielle"], tip_he:"je comprends... mais · loin de là · bien au contraire." },
      { instruction_he:"שכנע: הגנה על ערך", prompt_fr:"Défendez l'importance de la lecture dans le monde numérique.", trans_he:"הגנו על חשיבות הקריאה בעולם הדיגיטלי.", model_fr:"À l'heure du tout-numérique, la lecture reste irremplaçable. Elle développe la concentration, enrichit le vocabulaire et stimule l'imagination d'une façon qu'aucun écran ne peut égaler.", model_he:"בעידן הדיגיטלי המלא, הקריאה נשארת בלתי-ניתנת להחלפה. היא מפתחת ריכוז, מעשירה אוצר מילים ומגרה את הדמיון בצורה שאף מסך לא יכול להשוות לה.", keys_fr:["à l'heure de","irremplaçable","développe","enrichit","qu'aucun ... ne peut égaler"], tip_he:"à l'heure de (בעידן של) · irremplaçable · qu'aucun X ne peut égaler." },
    ],
    [ /* 5 — Spontané */
...
async function evaluateOpen(ex, answer, level = "B1") {
  ...
  return {
    ...
    correction_he: ex.model_he,
    correction_en: ex.model_en,
...
function MetroLine({ skill, correct, idx, sel, onSel, level }) {
  ...
  return (
    <div className="metro-row" style={{ animationDelay: `${0.1 + idx * 0.08}s` }}>
      ...
      <div className="metro-track" style={{ direction: lang === "he" ? "rtl" : "ltr" }}>
...
function BottomNav({ view, setView }) {
  ...
  return (
    <nav style={{
      ...
      borderTop: "1px solid rgba(200,162,58,0.18)",
      direction: dir,
    }}>
      <style>{`
        .bnav-tab { flex:1; display:flex; flex-direction:column; align-items:center; justify-content:center; padding:10px 0 max(10px, env(safe-area-inset-bottom)); gap:3px; cursor:pointer; border:none; background:transparent; font-family:'Assistant',sans-serif; }
        .bnav-icon { font-size:20px; line-height:1; }
        .bnav-label { font-size:11px; font-weight:700; letter-spacing:.03em; }
        .bnav-tab.active .bnav-label { color:#C8A23A; }
        .bnav-tab.active .bnav-bar { width:28px; height:2px; background:#C8A23A; border-radius:2px; margin-top:2px; }
        .bnav-tab:not(.active) .bnav-label { color:rgba(255,255,255,.38); }
        .bnav-tab:not(.active) .bnav-bar { display:none; }
      `}</style>
      {[
        { key: "dashboard", icon: "🏠", label: ui.home_tab },
        { key: "lessons",   icon: "📖", label: ui.lessons_tab },
      ].map(tab => (
        <button key={tab.key} className={`bnav-tab${view === tab.key ? " active" : ""}`} onClick={() => setView(tab.key)}>
          <span className="bnav-icon">{tab.icon}</span>
          <span className="bnav-label">{tab.label}</span>
          <span className="bnav-bar" />
        </button>
      ))}
    </nav>
  );
  ...
  return (
    <div onClick={handleClick} style={{ cursor: "pointer", perspective: 600 }}>
      ...
      <div className={`fc-inner${flipped ? " flipped" : ""}`}>
        <div className="fc-face fc-front">{fr}</div>
...
/*  LESSON CARD                                                          */
/* ==================================================================== */
function LessonCard({ lesson, index, ttsPlay }) {
  const { lang, ui } = useLang();
  const [open, setOpen] = useState(false);
  const dir = lang === "he" ? "rtl" : "ltr";
  const title = lang === "en" ? lesson.title_en : lesson.title_he;
  const theory = lang === "en" ? lesson.theory_en : lesson.theory_he;

  return (
    <div style={{ marginBottom: 10, borderRadius: 14, overflow: "hidden", border: "1.5px solid #DDD8CC", background: "#fff" }}>
      <button
        onClick={() => setOpen(o => !o)}
        style={{ width: "100%", display: "flex", alignItems: "center", gap: 12, padding: "14px 16px", border: "none", background: "transparent", cursor: "pointer", direction: dir, textAlign: dir === "rtl" ? "right" : "left", fontFamily: "'Assistant',sans-serif" }}
      >
        <span style={{ fontSize: 16, color: "#C8A23A", fontWeight: 900, minWidth: 28 }}>{open ? "▲" : "▶"}</span>
        <span style={{ fontSize: 11, fontWeight: 800, color: "#C8A23A", letterSpacing: ".06em", minWidth: 42 }}>
          {lang === "en" ? `LES. ${index + 1}` : `שיעור ${index + 1}`}
        </span>
        <span style={{ fontSize: 15, fontWeight: 700, color: "#1A1A2E", flex: 1 }}>{title}</span>
        {lesson.comingSoon && (
          <span style={{ fontSize: 11, background: "#E8E2D6", color: "#888", borderRadius: 20, padding: "2px 8px", fontWeight: 700 }}>
            {ui.lessons_coming_soon}
          </span>
        )}
      </button>
        ...
        <div style={{ padding: "0 16px 16px", direction: dir, borderTop: "1px solid #F0EBE0" }}>
          ...
          {lesson.grammar && (
            <div style={{ marginBottom: 16 }}>
              <div style={{ fontSize: 11, fontWeight: 800, color: "#C8A23A", letterSpacing: ".08em", marginBottom: 8 }}>{ui.lessons_grammar.toUpperCase()}</div>
              <div style={{ overflowX: "auto" }}>
                <table style={{ borderCollapse: "collapse", fontSize: 13, minWidth: "100%" }}>
                  <thead>
                    <tr>{lesson.grammar.headers.map((h, i) => (
                      <th key={i} style={{ textAlign: dir === "rtl" ? "right" : "left", padding: "6px 10px", background: "#F5F0E8", color: "#5A4A1A", fontWeight: 800, fontSize: 12, borderBottom: "2px solid #E7D49A", whiteSpace: "nowrap" }}>{h}</th>
                    ))}</tr>
                  </thead>
                  <tbody>
          ...
          {lesson.examples && lesson.examples.length > 0 && (
            <div>
              <div style={{ fontSize: 11, fontWeight: 800, color: "#C8A23A", letterSpacing: ".08em", marginBottom: 8 }}>{ui.lessons_examples.toUpperCase()}</div>
              {lesson.examples.map((ex, i) => (
                <div key={i} style={{ display: "flex", alignItems: "flex-start", gap: 10, padding: "8px 0", borderBottom: i < lesson.examples.length - 1 ? "1px solid #F0EBE0" : "none" }}>
                  <button
                    onClick={() => ttsPlay(ex.fr)}
                    style={{ flexShrink: 0, width: 30, height: 30, borderRadius: "50%", border: "1.5px solid #C8A23A", background: "#fff", cursor: "pointer", fontSize: 14, display: "flex", alignItems: "center", justifyContent: "center" }}
                  >🔊</button>
                  <div>
                    <div style={{ fontSize: 14, fontWeight: 700, color: "#1A1A2E", fontStyle: "italic" }}>{ex.fr}</div>
                    <div style={{ fontSize: 13, color: "#666", marginTop: 2 }}>{lang === "en" ? ex.en : ex.he}</div>
                  </div>
                </div>
              ))}
            </div>
      ...
      {open && lesson.comingSoon && (
        <div style={{ padding: "16px", borderTop: "1px solid #F0EBE0", textAlign: "center", color: "#AAA", fontSize: 14 }}>
          {lang === "en" ? "More lessons are coming soon! 🚀" : "שיעורים נוספים יגיעו בקרוב! 🚀"}
        </div>
      )}
    </div>
  );
...
function Lessons({ level, onBack }) {
  ...
  const LEVEL_HE = { A1: "מתחיל", A2: "בסיסי", B1: "עצמאי", B2: "מתקדם", C1: "שוטף", C2: "מומחה" };
    ...
    <div style={{ minHeight: "100vh", background: "#F5F0E8", fontFamily: "'Assistant',sans-serif", direction: dir }}>
      ...
      <div style={{ background: "linear-gradient(135deg,#1A1A2E 0%,#2D2B55 100%)", padding: "20px 20px 22px", color: "#F5F0E8" }}>
        <div style={{ maxWidth: 480, margin: "0 auto" }}>
          ...
          <h1 style={{ margin: 0, fontSize: 26, fontWeight: 800 }}>{levelLabel}</h1>
        </div>
      </div>
      ...
      <div style={{ maxWidth: 480, margin: "0 auto", padding: "16px 16px 0" }}>
        {lessons.map((lesson, i) => (
          <LessonCard key={lesson.id} lesson={lesson} index={i} ttsPlay={ttsPlay} />
        ))}
        {lessons.length === 0 && (
          <p style={{ textAlign: "center", color: "#AAA", marginTop: 40 }}>{ui.lessons_coming_soon}</p>
        )}
      </div>
    </div>
  );
