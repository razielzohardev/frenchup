  ...
  B1: {
    gra: [
      ...
      [ /* 2 — Pronoms COD */
        ...
        { instruction_en:"COD: placement with infinitive", trans_en:"I'm going to call my sister. → I'm going to call her.", explanation_en:"With futur proche: COD is placed before the infinitive: vais la appeler.", tip_en:"aller + la/le/les + infinitive · veux la voir · dois les faire." },
      ],
      [ /* 3 — Pronoms COI */
